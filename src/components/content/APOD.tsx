		...
		<>
			...
			<Section rx>
				<div className="w-full h-auto flex flex-col items-center justify-start md:p-4 md:w-[50%] md:max-w-2xl">
					{isLoading && <Skeleton className="w-full max-w-xl min-h-[40vh] mb-2 rounded-none md:rounded-2xl md:h-[75vh]" />}
				...
				<div className="w-full h-auto flex flex-col items-center justify-start pb-4 md:p-4 md:w-[50%] md:max-w-2xl">
					{isLoading ? <Skeleton className="w-full max-w-xl min-h-[40vh] mb-2 rounded-2xl mx-4 md:mx-0 md:h-[75vh]" /> : (
